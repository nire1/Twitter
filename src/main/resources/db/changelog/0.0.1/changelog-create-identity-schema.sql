...
--changeset DenisTsai:create-identity-schema
--comment create new identity schema
create schema identity;
--rollback drop schema identity;

--changeset DenisTsai:create-identity-user_accounts-table
...
--changeset DenisTsai:create-identity-user_roles-table
...
--changeset DenisTsai:create-identity-user_accounts_roles-table
...
--changeset DenisTsai:add-user_accounts_roles-table-constraints
...
--changeset DenisTsai:add-data-to-user_roles-table
